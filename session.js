...
const ERR_PROMPT_API_NOT_DETECTED = "The Prompt API is not available. Please check the <a href='https://aka.ms/edge-prompt-api-docs'>documentation</a> and try again.";
const ERR_SUMMARIZER_API_NOT_DETECTED = "The Summarizer API is not available. Please check the <a href='https://aka.ms/edge-prompt-api-docs'>documentation</a> and try again.";
const ERR_PROMPT_MODEL_NOT_AVAILABLE = "The Prompt API is available, but the model is not. Please check the <a href='https://aka.ms/edge-prompt-api-docs'>documentation</a> and try again.";
const ERR_SUMMARIZER_MODEL_NOT_AVAILABLE = "The Summarizer API is available, but the model is not. Please check the <a href='https://aka.ms/edge-prompt-api-docs'>documentation</a> and try again.";
